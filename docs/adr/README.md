...
| [0012](0012-cloudwatch-alarms-for-observability.md) | Native CloudWatch alarms, on three specific signals, over a third-party APM | Accepted |
| [0013](0013-eventbridge-narrow-role.md) | EventBridge only runs the cleanup cron - it isn't this service's event bus | Accepted |
| [0014](0014-serverless-v4-built-in-esbuild.md) | Rely on Serverless Framework v4's built-in esbuild, not the serverless-esbuild plugin | Accepted |
